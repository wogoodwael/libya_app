                          ...
                          GestureDetector(
                              onTap: () {
                                if (controller.data.isEmpty) {
                                  Get.snackbar(
                                      "خطأ", "سلة التسوق فارغة",
                                      backgroundColor: green,
                                      snackStyle: SnackStyle.FLOATING
                                  );
                                } else if (addressViewController.data.isEmpty) {
                                  Get.snackbar(
                                      "خطأ", "الرجاء إضافة عنوان",
                                      backgroundColor: green,
                                      snackStyle: SnackStyle.FLOATING
                                  );
                                } else {
                                  Get.to(() => const ConfirmOrders(), arguments: {
                                    "priceorder": cartController.totalPrice.toString()
                                  });
                                }
                              },
