...
import 'add_address_details_user.dart';


class AddAddressView2User extends StatelessWidget {
  const AddAddressView2User({super.key});

  @override
  Widget build(BuildContext context) {
    AddressController controllerpage = Get.put(AddressController());
    return SafeArea(
      child: Scaffold(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: InkWell(
                                onTap: (){
                                  Get.to(() => const AddAddressDetailsUser(),
                                      arguments:{
